...
| WP14 | Framerate-Umsetzung | **Schritte 1 bis 3 von 6 gebaut und gemessen** | Der GX-Strom jedes Bildes läuft ein zweites Mal (`MODERNGEKKO_GX_DRYRUN=1\|2\|3`), in Schritt 2 in einen Schatten-EFB, in Schritt 3 mit interpolierten XF-Matrizen. Bildgrenze berichtigt: die XFB-Kopie, nicht das Präsentieren (der EFB beim Präsentieren zeigte das nächste Bild ohne HUD). Danach Schatten und Bild in der Dateiauswahl bis auf die Bewegung gleich (0,2–2 % Pixel); Zwischenbild in der Dateiauswahl zu 75–77 % zwischen den Nachbarn, Mario plausibel, START-Schriftzug an den Kanten außerhalb ([20](20-VARIABLE-BILDRATE.md)). Offen: Szene mit Kamerabewegung (Eingabefolge endet in der Dateiauswahl), Absturz beim Beenden mit Vulkan, Sichtbarkeit (4), Taktentkopplung (5), Kosten auf echter GPU (6) |
