...
| [20-VARIABLE-BILDRATE.md](20-VARIABLE-BILDRATE.md) | Plan für WP14 in sechs Schritten, beide Vorabprüfungen erledigt. **Schritte 1 bis 3 gebaut und gemessen, Schritt 4 gebaut** (`recompcore-gx-trockenlauf.patch`, `MODERNGEKKO_GX_DRYRUN=1|2|3`, dazu `MODERNGEKKO_GX_DRYRUN_PRESENT=1`): der Strom läuft ein zweites Mal, in Schritt 2 in einen Schatten-EFB, in Schritt 3 mit interpolierten Matrizen, in Schritt 4 tritt das Zwischenbild bei 30-Hz-Bildern an die Stelle des XFB. Bildgrenze ist die XFB-Kopie (berichtigt am 16.09.). Offen: Bildprüfung von Schritt 4 (Weg: `headless_probe --gfx-setting DumpFrames=True`), Szene mit Kamerabewegung, Schritte 5–6 |
