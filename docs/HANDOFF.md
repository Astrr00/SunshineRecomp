...
| [20-VARIABLE-BILDRATE.md](20-VARIABLE-BILDRATE.md) | Plan für WP14 in sechs Schritten, beide Vorabprüfungen erledigt. **Schritte 1 und 2 gebaut und gemessen** (`recompcore-gx-trockenlauf.patch`, `MODERNGEKKO_GX_DRYRUN=1` oder `2`): der Strom läuft ein zweites Mal, in Schritt 2 in einen Schatten-EFB, der auf Vulkan/Lavapipe das Bild trägt. Schritte 3–6 offen |
