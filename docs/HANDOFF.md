...
| [20-VARIABLE-BILDRATE.md](20-VARIABLE-BILDRATE.md) | Plan für WP14 in sechs Schritten, beide Vorabprüfungen erledigt. **Schritte 1 bis 3 gebaut und gemessen** (`recompcore-gx-trockenlauf.patch`, `MODERNGEKKO_GX_DRYRUN=1`, `2` oder `3`): der Strom läuft ein zweites Mal, in Schritt 2 in einen Schatten-EFB, in Schritt 3 mit interpolierten Matrizen. Bildgrenze ist die XFB-Kopie (berichtigt am 16.09.). Offen: Messung in einer Szene mit Kamerabewegung, Absturz beim Beenden auf Vulkan, Schritte 4–6 |
